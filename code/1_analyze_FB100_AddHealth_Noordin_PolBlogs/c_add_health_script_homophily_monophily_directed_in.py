...
if __name__=="__main__":
    ...
    file_output = open('../../data/output/add_health_output_in_directed_links_homophily_monophily_NatureHB_Nov2017.csv', 'wt') # change file name to directed
    j =0
    ...
    for f in listdir(args.input_dir):
        if f.endswith(args.file_ext):
            ...
            if len(block_size_gender) >= 2:
                ...
                ## added 11/9/2017
                monophily_gender_bb = monophily_index_beta_bin(adj_gender_in, np.array(ah_gender_in))
