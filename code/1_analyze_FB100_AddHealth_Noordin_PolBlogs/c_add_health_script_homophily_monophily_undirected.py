...
## python c_add_health_script_homophily_monophily_undirected.py -i='/Users/kristen/Dropbox/gender_graph_data/add-health/converted_gml' -o='/Users/kristen/Dropbox/gender_graph_data/manuscript/nature_hb/gender_graph_final_code_NatureHB/data/output'
...
if __name__=="__main__":
    ...
    file_output = open('../../data/output/add_health_output_undirected_links_homophily_monophily_NatureHB_Nov2017.csv', 'wt')
    j =0
    ...
    for f in listdir(args.input_dir):
        if f.endswith(args.file_ext):
            ...
            if len(block_size_gender) >= 2:
                ...
                ## added 11/9/2017
                monophily_gender_bb = monophily_index_beta_bin(adj_directed_gender_undirected, np.array(ah_gender_undirected))
